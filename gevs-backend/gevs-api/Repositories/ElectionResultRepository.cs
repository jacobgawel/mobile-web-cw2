...
namespace gevs_api.Repositories
{
    public class ElectionResultRepository : IElectionResultRepository
    {
        ...
        public ElectionResultRepository(GevsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ElectionResult> GetElectionResults()
        {
            ...
            var constituencies = await _context.Constituencies.AsNoTracking().ToListAsync();
            ...
            var election = await _context.Elections.AsNoTracking().ToListAsync();
